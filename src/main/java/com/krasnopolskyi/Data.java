...
public class Data {
    ...
    public static final TraineeDto JOHN_TRAINEE_LONG_NAME = TraineeDto.builder().firstName("Johndfgsdfgffgdsfgsdff").lastName("black").dateOfBirth(LocalDate.of(1999, 11, 23)).address("new address").build();
